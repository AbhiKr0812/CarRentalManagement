...
namespace CarRentalManagement.Api.Models.DTOs
{
    public class AddCarRequestDto
    {
        ...
        [Required]
        [MinLength(3, ErrorMessage = "Color Name has to be a minimum of 3 characters")]
        [MaxLength(15, ErrorMessage = "Color Name has to be a maximum of 15 characters")]
        ...
        [Required]
        [MinLength(4, ErrorMessage = "Car Maker Name has to be a minimum of 4 characters")]
        [MaxLength(24, ErrorMessage = "Car Maker Name has to be a maximum of 24 characters")]
