...
namespace CarRentalManagement.Api.Models.DTOs
{
    ...
    {
        [Required]
        [MinLength(4, ErrorMessage = "Customer Name has to be a minimum of 4 characters")]
        [MaxLength(100, ErrorMessage = "Customer Name has to be a maximum of 100 characters")]
